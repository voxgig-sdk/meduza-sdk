...
class MeduzaFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; MeduzaSDK/1.0)';
    ...
    public static function call(MeduzaContext $ctx, string $fullurl, array $fetchdef): array
    {

...
// Meduza SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class MeduzaMakeRequest
{
    public static function call(MeduzaContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new MeduzaResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new MeduzaResponse($fetched);
        } else {

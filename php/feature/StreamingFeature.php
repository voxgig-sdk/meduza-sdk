...
class MeduzaStreamingFeature extends MeduzaBaseFeature
{
    ...
    private function _iterate(MeduzaResult $result): \Generator
    {
    ...
    private function _streamable(MeduzaContext $ctx): bool
    {

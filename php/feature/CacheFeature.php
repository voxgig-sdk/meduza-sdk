...
class MeduzaCacheFeature extends MeduzaBaseFeature
{
    ...
    private function _through(MeduzaContext $ctx, string $url, array $fetchdef, callable $inner): array
    {

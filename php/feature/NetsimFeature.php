...
class MeduzaNetsimFeature extends MeduzaBaseFeature
{
    ...
    private function _simulate(MeduzaContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(MeduzaContext $ctx, array $applied): void
    {
        $client = $this->client;

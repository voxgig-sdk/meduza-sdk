# Meduza PHP SDK Reference

Complete API reference for the Meduza PHP SDK.
...
#### `MeduzaSDK::test($testopts = null, $sdkopts = null)`
...
| `image` | `array` | No | Article image information |

...
class NewEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set MEDUZA_TEST_NEW_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function new_basic_setup($extra)
{
    ...
    $client = MeduzaSDK::test($options, $extra);
    ...
    $entid_env_raw = getenv("MEDUZA_TEST_NEW_ENTID");
    ...
    if ($env["MEDUZA_TEST_LIVE"] === "TRUE") {
        ...
        $client = new MeduzaSDK(Helpers::to_map($merged_opts));
    }

...
// Meduza SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (MeduzaSDK::test)
...
{
    private const SDK_CLASS = 'MeduzaSDK';
    ...
    private const SDK_BASE = 'meduza_sdk';

...
// Meduza SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = MeduzaOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(MeduzaOmni::structfix($now, Struct::undef()))
                        !== json_encode(MeduzaOmni::structfix($val, Struct::undef()))) {

...
class MeduzaTestRunner
{
    ...
    {
        $live = self::getenv('MEDUZA_TEST_LIVE');
        $override = self::getenv('MEDUZA_TEST_OVERRIDE');
        ...
        $explain = self::getenv('MEDUZA_TEST_EXPLAIN');
...
class_alias('MeduzaTestRunner', 'Runner');
class_alias('MeduzaHelpers', 'Helpers');

...
from meduza_sdk.utility import register

# Load features
from meduza_sdk.feature.base_feature import MeduzaBaseFeature
from meduza_sdk.features import _has_feature, _make_feature
...
class MeduzaSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = MeduzaUtility()
        self._utility = utility

        from meduza_sdk.config import shared_config
    ...
    def get_utility(self):
        return MeduzaUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("MeduzaSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def New(self, data=None) -> "NewEntity":
        ...
        from meduza_sdk.entity.new_entity import NewEntity
        return NewEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "MeduzaSDK":
        if sdkopts is None:
            sdkopts = {}

# Meduza SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions MeduzaSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both MeduzaSDK(...) and MeduzaSDK.test(...) become
#      MeduzaSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "meduza_sdk"
_SDK_CLASS = "MeduzaSDK"

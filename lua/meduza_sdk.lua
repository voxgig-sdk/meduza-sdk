...
MeduzaSDK._make_feature = _make_feature


function MeduzaSDK.new(options)
  local self = setmetatable({}, MeduzaSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function MeduzaSDK:options_map()
...
function MeduzaSDK:get_utility()
  return Utility.copy(self._utility)
end


function MeduzaSDK:get_root_ctx()
  return self._rootctx
end


function MeduzaSDK:prepare(fetchargs)
...
function MeduzaSDK:direct(fetchargs)
...
-- by passing it.
function MeduzaSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function MeduzaSDK:graphql(query, variables, ctrl)
...
function MeduzaSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = MeduzaSDK.new(sdkopts)
  sdk.mode = "test"

...
Results: Successfully retrieved news articles.
...
| --- | --- | --- | --- |
| New | `list` | `GET /screens/news` | See reference |

## Connect to the API

- Meduza API Server: `https://meduza.io/api/w5`
...
- `meduza_list`: List records for an entity. Supported entities: `new`.
- `meduza_load`: Load one record for an entity. No active entity supports this operation.

...
|---|---|---|
| `ts/` | @voxgig-sdk/meduza-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/meduza-sdk \
      --repository voxgig-sdk/meduza-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/meduza-sdk` shows it, and
`npm trust revoke @voxgig-sdk/meduza-sdk --id=<id>` removes it.

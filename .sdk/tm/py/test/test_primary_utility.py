...
from projectname_sdk import MeduzaSDK
from projectname_sdk.core.spec import MeduzaSpec
from projectname_sdk.core.result import MeduzaResult
from projectname_sdk.core.response import MeduzaResponse
from projectname_sdk.core.operation import MeduzaOperation
from projectname_sdk.core.error import MeduzaError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import MeduzaBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = MeduzaSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = MeduzaSDK.test(None, None)
        ...
        class TestInitFeature(MeduzaBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(MeduzaBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = MeduzaSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = MeduzaSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = MeduzaSDK.test(None, setup_opts)

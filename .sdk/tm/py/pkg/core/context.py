...
from projectname_sdk.core.control import MeduzaControl
...
class MeduzaContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, MeduzaResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return MeduzaError(code, msg, self)

...
{
    private static function utility(): MeduzaUtility
    {
        return new MeduzaUtility();
    }
    ...
    private static function ctx(array $over = []): MeduzaContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new MeduzaContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new MeduzaOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof MeduzaError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new MeduzaOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = MeduzaMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new MeduzaOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = MeduzaMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new MeduzaOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = MeduzaMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new MeduzaSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = MeduzaMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new MeduzaResponse([]),
            'result' => new MeduzaResult([]),
        ]);
        [, $err] = MeduzaMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new MeduzaSpec(['step' => 's']),
            'response' => new MeduzaResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new MeduzaResult([]),
        ]);
        [, $err] = MeduzaMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new MeduzaSpec(['step' => 's']),
            'response' => new MeduzaResponse(self::resp(200, ['v' => 1])),
            'result' => new MeduzaResult([]),
        ]);
        [, $err] = MeduzaMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new MeduzaSpec(['step' => 's']),
            'response' => new MeduzaResponse(self::resp(200, ['v' => 2])),
            'result' => new MeduzaResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        MeduzaMakeResponse::call($ctx);
    ...
    {
        $preset = new MeduzaResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new MeduzaSpec([]),
            'response' => new MeduzaResponse([]),
            'result' => new MeduzaResult([]),
        ...
        [$got, $err] = MeduzaMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new MeduzaResult([])]);
        [, $err] = MeduzaMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new MeduzaSpec([]), 'result' => null]);
        [, $err] = MeduzaMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new MeduzaSpec(['step' => 's']),
            'result' => new MeduzaResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new MeduzaOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = MeduzaMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new MeduzaSpec(['step' => 's']),
            'result' => new MeduzaResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new MeduzaOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = MeduzaMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new MeduzaResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new MeduzaSpec([]),
            'result' => new MeduzaResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = MeduzaMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = MeduzaMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new MeduzaError('boom', 'boom');
        $utility->fetcher = function (MeduzaContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new MeduzaSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = MeduzaMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (MeduzaContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = MeduzaMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(MeduzaResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (MeduzaContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new MeduzaSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = MeduzaMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new MeduzaResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new MeduzaSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = MeduzaMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = MeduzaMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = MeduzaMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new MeduzaResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, MeduzaDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new MeduzaResult(['ok' => false])]);
        $this->expectException(MeduzaError::class);
        MeduzaDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new MeduzaResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', MeduzaMakeError::call($ctx, null));
    }
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new MeduzaBaseFeature();
        $b = new MeduzaBaseFeature();
        MeduzaFeatureAdd::call($ctx, $a);
        MeduzaFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): MeduzaBaseFeature
    {
        $f = new MeduzaBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        MeduzaFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): MeduzaContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new MeduzaSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = MeduzaPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new MeduzaResponse(['headers' => null]),
            'result' => new MeduzaResult([]),
        ]);
        MeduzaResultHeaders::call($ctx);

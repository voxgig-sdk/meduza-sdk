...
class MeduzaTimeoutFeature extends MeduzaBaseFeature
{
    ...
    private function _with_timeout(MeduzaContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(MeduzaContext $_ctx, float $ms): void
    {
        $client = $this->client;

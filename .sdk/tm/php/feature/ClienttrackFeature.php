...
// Meduza SDK clienttrack feature
...
class MeduzaClienttrackFeature extends MeduzaBaseFeature
{
    ...
    public function PostConstruct(MeduzaContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Meduza-SDK';

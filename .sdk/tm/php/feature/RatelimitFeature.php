...
class MeduzaRatelimitFeature extends MeduzaBaseFeature
{
    ...
    private function _acquire(MeduzaContext $ctx): void
    {
    ...
    private function _track(MeduzaContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;

...
class MeduzaRbacFeature extends MeduzaBaseFeature
{
    ...
    private function _required(MeduzaContext $ctx): ?string
    {
    ...
    private function _reject(MeduzaContext $ctx, string $required): void
    {
    ...
    private function _track(MeduzaContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;

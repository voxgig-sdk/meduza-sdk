...
class MeduzaProxyFeature extends MeduzaBaseFeature
{
    ...
    public function init(MeduzaContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (MeduzaContext $ctx2, string $url2, array $fetchdef) use ($inner): array {

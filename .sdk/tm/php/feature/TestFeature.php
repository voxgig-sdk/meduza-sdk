...
// Meduza SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class MeduzaTestFeature extends MeduzaBaseFeature
{
    ...
    public function init(MeduzaContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (MeduzaContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (MeduzaContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(MeduzaContext $ctx, $op, $args): array
    {

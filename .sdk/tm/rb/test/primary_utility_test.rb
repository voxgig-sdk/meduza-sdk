...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = MeduzaOmni.make_runner(TEST_JSON_FILE, MeduzaSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : MeduzaOmni.errify(err)
    end

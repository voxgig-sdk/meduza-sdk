...
func registerTools(server *mcp.Server, client *sdk.MeduzaSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "meduza_list",
		Description: "List records from Meduza. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "meduza_load",
		Description: "Load a single record from Meduza. " +
...
func runOp(client *sdk.MeduzaSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.MeduzaSDK, name string) (sdk.MeduzaEntity, error) {

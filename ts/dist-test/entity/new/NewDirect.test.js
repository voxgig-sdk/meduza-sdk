...
function liveScenariosActive() { return false && process.env.MEDUZA_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.MeduzaSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['MEDUZA_TEST_NEW_ENTID'];
    ...
    const client = new __1.MeduzaSDK({
        base: 'http://localhost:8080',

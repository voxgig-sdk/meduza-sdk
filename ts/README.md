# Meduza TypeScript SDK



The TypeScript SDK for the Meduza API — a type-safe, entity-oriented client with full async/await support.
...
- Releases: [https://github.com/voxgig-sdk/meduza-sdk/releases](https://github.com/voxgig-sdk/meduza-sdk/releases)
...
| `tester(testopts?, sdkopts?)` | `MeduzaSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `MeduzaSDK.test(testopts?, sdkopts?)` | `MeduzaSDK` | Create a test-mode client. |
...
| `client` | `client(): MeduzaSDK` | Return the parent SDK client. |

...
func registerSDKWords(r *eng.Registry, client *sdk.MeduzaSDK) {
...
func runOp(client *sdk.MeduzaSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {

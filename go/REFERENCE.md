# Meduza Golang SDK Reference

Complete API reference for the Meduza Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *MeduzaSDK`
...
#### `New(data map[string]any) MeduzaEntity`
...
| `image` | `map[string]any` | No | Article image information |
